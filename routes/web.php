...
Route::middleware('auth')->group(function () {
    ...
    Route::get('google_map_orders', 'DashboardController@ordersMap');
    ...
    Route::resource('superettes', 'RestaurantController')->except([
        'show'
    ]);



    Route::post('supcategories/remove-media', 'SupCategoryController@removeMedia');
    Route::resource('supcategories', 'SupCategoryController');
    ...
    Route::get('status/fetchStatus', 'OrderStatusController@fecthStatus');

    // Route::resource('orderHistories', 'OrderHistoryController')->except([
    //     'create', 'store', 'destroy'
    // ]);
    ...
    Route::resource('topfoods', 'TopFoodController');

    // Route::post('foodOrders/remove-media', 'FoodOrderController@removeMedia');
    ...
    Route::get('order/histories', 'OrderController@OrderHistories');
    Route::post('order/new_food', 'OrderController@addNewFood');

    

    Route::post('customorder/delete', 'OrderController@action');
    Route::post('customorder/edit', 'OrderController@editCustom');

    Route::post('foodorder/remove', 'OrderController@removeOrder');
    Route::post('foodorder/edit', 'OrderController@editOrder');
    Route::post('order/editStatus', 'OrderController@editStatus');
    Route::post('order/activeOrder', 'OrderController@activeOrder');
    ...
    Route::post('annonces/remove-media', 'AnnonceController@removeMedia');
    Route::resource('annonces', 'AnnonceController');
    Route::resource('claims', 'ClaimController');
    Route::resource('claimcustomers', 'ClaimCustomerController');
    Route::post('subclaims/remove', 'ClaimController@removeSubClaim');
    Route::post('subclaims/edit', 'ClaimController@editSubClaim');
    Route::post('subclaims/new', 'ClaimController@newSubclaim');
    Route::post('addMoreSubClaim', 'ClaimController@addMoreSubClaim');

    

    Route::get('ajaxCatgeories', 'DashboardController@ajaxCatgeories');
    Route::get('ajaxOrders', 'DashboardController@ajaxOrders');
    Route::get('ajaxDrivers', 'DashboardController@ajaxDrivers');
    ...
    Route::get('stocks/GetRestaurants', 'StockController@FetchRestauFood');
    Route::post('stocks/EditStock', 'StockController@EditStock');
