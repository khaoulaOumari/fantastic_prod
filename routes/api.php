...
Route::prefix('driver')->group(function () {
    ...
    Route::post('active_delivery/{id}', 'API\Driver\UserAPIController@activeAvailable');
...
Route::get('fetchProdCategory/{id}', 'API\CategoryAPIController@fetchProdCategory');

Route::resource('supcategories', 'API\SupCategoryAPIController');

Route::get('foodsupcategories', 'API\SupCategoryAPIController@Fetch');
...
Route::get('foods/promo', 'API\FoodAPIController@FetchPromoFood');
Route::resource('foods', 'API\FoodAPIController');

Route::get('getFoods', 'API\FoodAPIController@getFoods');
Route::get('claimsCustomer', 'ClaimController@claimsCustomer');


Route::get('searchFoods', 'API\FoodAPIController@fetchFoods');

Route::get('qrcodeOrder/{id}', 'API\OrderAPIController@qrcodeOrder');
...
Route::middleware('auth:api')->group(function () {
    Route::group(['middleware' => ['role:driver']], function () {
        Route::prefix('driver')->group(function () {
            ...
            Route::post('editWay/{id}', 'API\OrderAPIController@editOrderWay');
            Route::post('editStatus', 'API\OrderAPIController@editStatus');

            Route::resource('notifications', 'API\NotificationAPIController');
            Route::post('users/{id}', 'API\UserAPIController@update');
            Route::resource('faq_categories', 'API\FaqCategoryAPIController');
            Route::resource('faqs', 'API\FaqAPIController');
            Route::get('driverOrders', 'API\Driver\UserAPIController@driverOrders');
            Route::get('authUser', 'API\Driver\UserAPIController@authUser');
    ...
    Route::get('userClaims', 'API\ClaimAPIController@fetchUserClaim');
