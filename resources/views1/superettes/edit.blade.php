    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{!! route('superettes.index') !!}">{{trans('lang.restaurant_plural')}}</a>
          </li>
...
<div class="content">
  ...
  <div class="card">
    ...
    <div class="card-body">
      {!! Form::model($restaurant, ['route' => ['superettes.update', $restaurant->id], 'method' => 'patch']) !!}
      <div class="row">
        @include('superettes.fields')
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
    </div>
