...
<!-- <div class="form-group row ">
  {!! Form::label('color', trans("lang.order_status_color"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::text('color', null,  ['class' => 'form-control colorpicker','placeholder'=>  trans("lang.order_status_color_placeholder")]) !!}
    <div class="form-text text-muted">
      {{ trans("lang.order_status_status_help") }}
    </div>
  </div>
