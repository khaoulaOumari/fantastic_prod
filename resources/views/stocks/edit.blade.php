  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        @can('stocks.create')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('stocks.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.stock_create')}}</a>
        </li>
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>{{trans('lang.stock_edit')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      {!! Form::model($food, ['route' => ['stocks.update', $food->id], 'method' => 'patch']) !!}
      <div class="row">
