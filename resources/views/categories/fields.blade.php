...
<div class="form-group row ">
        {!! Form::label('supcategory_id', trans("lang.category_sup"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('supcategory_id', $supcategory, null, ['class' => 'select2 form-control']) !!}
