...
<div class="form-group row ">
        {!! Form::label('prix_achat', trans("lang.purchase_price"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('prix_achat', null,  ['class' => 'form-control','placeholder'=>  trans("lang.purchase_price"),'step'=>"any", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.purchase_price") }}
            </div>
        </div>
    </div>
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Restaurant Id Field -->
    <div class="form-group row ">
        {!! Form::label('restaurants[]', trans("lang.food_restaurant_id"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('restaurants[]', $restaurants, $restaurantsSelected, ['class' => 'select2 form-control','multiple'=>'multiple']) !!}
