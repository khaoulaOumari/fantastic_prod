...
@can('superettes.index')
    <li class="nav-item has-treeview {{ (Request::is('restaurants*') || Request::is('requestedRestaurants*') || Request::is('galleries*') || Request::is('restaurantReviews*')) && !Request::is('restaurantsPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('restaurants*') || Request::is('requestedRestaurants*') || Request::is('galleries*') || Request::is('restaurantReviews*')) && !Request::is('restaurantsPayouts*')? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-home"></i>@endif
        ...
        <ul class="nav nav-treeview">
            @can('superettes.index')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('restaurants*') ? 'active' : '' }}" href="{!! route('superettes.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-home"></i>@endif<p>{{trans('lang.restaurant_plural')}}</p></a>
                </li>
            @endcan
            <!-- @can('galleries.index')
                <li class="nav-item">
...
<li class="nav-item has-treeview {{ (Request::is('supcategories*')  || Request::is('categories*') ) ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('supcategories*')  || Request::is('categories*')) ? 'active' : '' }}"> @if($icons)
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
            <a class="nav-link {{ Request::is('supcategories*') ? 'active' : '' }}" href="{!! route('supcategories.index') !!}">@if($icons)
                <i class="nav-icon fa fa-folder"></i>@endif<p>{{trans('lang.category_plural_sup')}}</p></a>
            </li>
...
@can('foods.index')
    <li class="nav-item has-treeview {{ Request::is('foods*') || Request::is('extra*') || Request::is('foodReviews*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('foods*') || Request::is('extra*') || Request::is('foodReviews*') || Request::is('nutrition*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-th-large"></i>@endif
...
@can('stocks.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('stocks*') ? 'active' : '' }}" href="{!! route('stocks.index') !!}">@if($icons)<i class="nav-icon fa fa-th-list"></i>@endif<p>{{trans('lang.stock_plural')}} </p></a>
    </li>
@endcan
...
<li class="nav-item has-treeview {{ Request::is('annonces*') || Request::is('slides*')? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('annonces*') || Request::is('slides*')? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-bullhorn"></i>@endif
            <p>{{trans('lang.annonce_plural')}} <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
        @can('annonces.index')
          <li class="nav-item">
            <a class="nav-link {{ Request::is('annonces*') ? 'active' : '' }}" href="{!! route('annonces.index') !!}">@if($icons)<i class="nav-icon fa fa-bullhorn"></i>@endif<p>{{trans('lang.annonce_plural')}}</p></a>
        </li>
        @endcan
...
@can('claims.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('claims*') ? 'active' : '' }}" href="{!! route('claims.index') !!}">@if($icons)<i class="nav-icon fa fa-exclamation"></i>@endif<p>{{trans('lang.claim_plural')}} </p></a>
    </li>
@endcan

@can('claimcustomers.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('claimcustomers*') ? 'active' : '' }}" href="{!! route('claimcustomers.index') !!}">@if($icons)<i class="nav-icon fa fa-question"></i>@endif<p>{{trans('lang.claimcustomers_plural')}} </p></a>
    </li>
@endcan
        ...
        <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
                <a href="{!! url('settings/mobile/colors') !!}" class="nav-link {{  Request::is('settings/mobile/colors*') ? 'active' : '' }}">
                    @if($icons)<i class="nav-icon fa fa-pencil"></i> @endif <p>{{trans('lang.mobile_colors')}} 
                    </p>
                </a>
            </li>
