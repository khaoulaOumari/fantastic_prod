...
<script type="text/javascript">
    ...
    var dz_var15866134771240834480ble = $(".dropzone.image").dropzone({
        ...
        removedfile: function (file) {
            dzRemoveFile(
                file, var15866134771240834480ble, '{!! url("supcategories/remove-media") !!}',
...
<div class="form-group col-12 text-right">
  ...
  <a href="{!! route('supcategories.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
