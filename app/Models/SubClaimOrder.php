 ...
 */
class SubClaimOrder extends Model
{

    public $table = 'sub_claims_orders';
     ...
     */
    public static $rules = [
        'sub_claim_id' => 'required|exists:claims,id',
     ...
     **/
    public function subClaim()
    {
        return $this->belongsTo(\App\Models\SubClaim::class, 'sub_claim_id', 'id');
    }
