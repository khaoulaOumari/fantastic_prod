...
class AssignedOrder extends Notification
{
    ...
    public function toFcm($notifiable)
    {
        ...
        $notification = [
            ...
            'text'         => $this->order->foodOrders[0]->food->name,
            'image' => $this->order->foodOrders[0]->food->getFirstMediaUrl('image', 'thumb'),
            'icon' => $this->order->foodOrders[0]->food->getFirstMediaUrl('image', 'thumb'),
        ];
        $data = [
