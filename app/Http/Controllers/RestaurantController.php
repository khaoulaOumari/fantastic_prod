...
class RestaurantController extends Controller
{
    ...
    {
        return $restaurantDataTable->render('superettes.index');
    }
    ...
    {
        return $requestedRestaurantDataTable->render('superettes.requested');
    }
    ...
    public function create()
    {
        ...
        return view('superettes.create')->with("customFields", isset($html) ? $html : false)->with("user", $user)->with("drivers", $drivers)->with("usersSelected", $usersSelected)->with("driversSelected", $driversSelected)->with('cuisine', $cuisine)->with('cuisinesSelected', $cuisinesSelected);
    }
    ...
    public function show($id)
    {
        ...
        return view('superettes.show')->with('restaurant', $restaurant);
    }
    ...
    public function edit($id)
    {
        ...
        return view('superettes.edit')->with('restaurant', $restaurant)->with("customFields", isset($html) ? $html : false)->with("user", $user)->with("drivers", $drivers)->with("usersSelected", $usersSelected)->with("driversSelected", $driversSelected)->with('cuisine', $cuisine)->with('cuisinesSelected', $cuisinesSelected);
    }
    ...
    public function getAdress(Request $request){
        $client = new Client();
        $res = $client->get('https://maps.googleapis.com/maps/api/geocode/json?latlng='.$request->lat.','.$request->lng.'&key=AIzaSyCIUe8WwDxmcJNDkiYmD0E_AUdJ41sgR2A');
