...
class FoodController extends Controller
{
    ...
    public function create()
    {
        ...
        if (auth()->user()->hasRole('admin')) {
            ...
            $restaurant = $this->restaurantRepository->myActiveRestaurants()->pluck('name', 'id')->toArray();
        }
        ...
        return view('foods.create')->with("customFields", isset($html) ? $html : false)->with("restaurants", $restaurant)->with("restaurantsSelected", $restaurantsSelected)->with("category", $category);
    }
    ...
    public function edit($id)
    {
        ...
        return view('foods.edit')->with('food', $food)->with("customFields", isset($html) ? $html : false)->with("restaurants", $restaurant)->with("restaurantsSelected", $restaurantsSelected)->with("category", $category);
    }
