...
//                }
            }else if (Str::contains(url()->previous(), "app/fees")){
                if (empty($input['average_price'])) {
                    unset($input['average_price']);
                }
                if (empty($input['more_price_fees'])) {
                    unset($input['more_price_fees']);
                }
                if (empty($input['less_price_fees'])) {
                    unset($input['less_price_fees']);
                }
            }
