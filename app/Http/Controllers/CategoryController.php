...
class CategoryController extends Controller
{
    ...
    SupCategoryRepository $supCategoryRepo)
    {
        parent::__construct();
    ...
    {
        $supcategory = $this->supCategoryRepository->pluck('name', 'id');
        ...
        return view('categories.create')->with("supcategory", $supcategory)->with("customFields", isset($html) ? $html : false);
    }
    ...
    public function edit($id)
    {
        ...
        return view('categories.edit')->with('category', $category)->with("supcategory", $supcategory)->with("customFields", isset($html) ? $html : false);
    }
