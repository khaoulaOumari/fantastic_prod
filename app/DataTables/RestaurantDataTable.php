...
class RestaurantDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('active', function ($restaurant) {
                ...
                if($restaurant->active){
                    return '<div class="checkbox-switch">
                            <input type="checkbox" checked=""  value="1" onclick="activeSup('.$restaurant->id.');" name="active" class="input-checkbox" id="active['.$restaurant->id.']">
            ...
            ->addColumn('action', 'superettes.datatables_actions')
