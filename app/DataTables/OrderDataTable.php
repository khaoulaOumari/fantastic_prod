        ...
        $dataTable = $dataTable
            ...
            ->editColumn('tax', function ($order) {
                ...
                foreach($status as $row) {
                    if($order->order_status_id == $row->id){
                        $txt .="<option value=".$row->id." selected>".$row->status."</option>";
                    }else{
                        $txt .="<option value=".$row->id.">".$row->status."</option>";
                    }
            ...
            ->editColumn('active', function ($order) {
                // return getBooleanColumn($order, 'active');
                if($order->active){
                    return '<div class="checkbox-switch">
                            <input type="checkbox" checked=""  value="1" onclick="activeOrder('.$order->id.');" name="active" class="input-checkbox" id="active['.$order->id.']">
                    ...
                    return '<div class="checkbox-switch">
                            <input type="checkbox" value="0" onclick="activeOrder('.$order->id.');" name="active" class="input-checkbox" id="active['.$order->id.']">
                            <div class="checkbox-animate">
                            <span class="checkbox-off">Oui</span>
                            <span class="checkbox-on">Non</span>
                            </div>
