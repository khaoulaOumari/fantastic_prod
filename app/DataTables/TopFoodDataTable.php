...
class TopFoodDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('food_count', function ($food) {
                return $food['food_count'].' Commandes ';
            })
            ...
            // })
            ->addColumn('action', 'topfoods.datatables_actions')
    ...
    public function query(Food $model)
    {
        ...
        if (auth()->user()->hasRole('admin')) {
            ...
            ->leftjoin('food_orders', 'foods.id', '=', 'food_orders.food_id')
            ->select('foods.*',DB::raw('count(foods.id) as food_count'))
            ->groupBy('foods.id')->orderBy('foods.updated_at','desc');
            ...
            return $model->newQuery()->with("category")
                ...
                ->groupBy('foods.id')
                ->select('foods.*',DB::raw('count(foods.id) as food_count'))->orderBy('foods.updated_at', 'desc');
