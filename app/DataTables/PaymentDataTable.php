        ...
        $dataTable = $dataTable
            ...
            ->editColumn('method', function ($payment) {
                if($payment->method == 'Pay on Pickup'){
                    return "<span class='badge badge-success'>Cache à la livraison</span>";
                }
                else{
                    return "<span class='badge badge-warning'>" .$payment->method. "</span>";
                }
            })
            ->editColumn('status', function ($payment) {
                if($payment->status == 'Attente du client' || $payment->status == 'Waiting for Client'){
                    return "<span class='badge badge-warning'>Attente du client</span>";
                }
                ...
                if($payment->status == 'Not Paid'){
                    ...
                    return "<span class='badge badge-success'>".$payment->status."</span>";
                }
            })
